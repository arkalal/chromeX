...
const ContactPage = () => {
  return (
    <div className={styles.contactContainer}>
      <h1 className={styles.title}>Contact BrowzPot Team</h1>
      ...
      <div className={styles.contactHeader}>
        <h1>Get In Touch</h1>
        <p>
          Have questions about BrowzPot? We&apos;re here to help! Feel free to reach out
      ...
      <div className={styles.contactCard}>
        <div className={styles.founderInfo}>
          <div className={styles.founderDetails}>
            ...
            <p>
              Thank you for your interest in BrowzPot! I&apos;m excited to hear your
      ...
      <div className={styles.responsePromise}>
        ...
        <p>Contact the BrowzPot team for support, feedback, or partnership inquiries. We aim to respond to all inquiries within 24-48 hours during business days. Thank you for your patience and for choosing BrowzPot!</p>
      </div>
    </div>
  );
};
